...
void Assembler::bndcl(BNDRegister dst, Register src) {
  emit_int8((unsigned char)0xF3);
  emit_int8((unsigned char)0x0F);
  emit_int8((unsigned char)0x1A);
  emit_int8((unsigned char)(0xC0 | dst->encoding() << 3 | src->encoding()));
}

void Assembler::bndcl(BNDRegister dst, Address src) {
  emit_int8((unsigned char)0xF3);
  emit_int8((unsigned char)0x0F);
  emit_int8((unsigned char)0x1A);
...
void Assembler::bndcu(BNDRegister dst, Register src) {
  emit_int8((unsigned char)0xF2);
  emit_int8((unsigned char)0x0F);
  emit_int8((unsigned char)0x1A);
  emit_int8((unsigned char)(0xC0 | dst->encoding() << 3 | src->encoding()));
...
void Assembler::bndcu(BNDRegister dst, Address src) {
  emit_int8((unsigned char)0xF2);
  emit_int8((unsigned char)0x0F);
  emit_int8((unsigned char)0x1A);
  emit_operand((Register)dst, src);
...
void Assembler::bndmk(BNDRegister dst, Address src) {
    emit_int8((unsigned char)0xF3);
    emit_int8((unsigned char)0x0F);
    emit_int8((unsigned char)0x1B);
    emit_operand((Register)dst, src);
}

void Assembler::bndmov(BNDRegister dst, Address src) {
    emit_int8((unsigned char)0x66);
    emit_int8((unsigned char)0x0F);
    emit_int8((unsigned char)0x1A);
    emit_operand((Register)dst, src);
...
void Assembler::bndmov(Address dst, BNDRegister src) {
    emit_int8((unsigned char)0x66);
    emit_int8((unsigned char)0x0F);
    emit_int8((unsigned char)0x1B);
...
void Assembler::bndmov(BNDRegister dst, BNDRegister src) {
  emit_int8((unsigned char)0x66);
  emit_int8((unsigned char)0x0F);
  emit_int8((unsigned char)0x1A);
  emit_int8((unsigned char)(0xC0 | dst->encoding() << 3 | src->encoding()));
