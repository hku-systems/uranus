...
address TemplateInterpreterGenerator::generate_exception_handler_common(
  ...
  __ lea(c_rarg1, ExternalAddress((address)name));
  if (pass_oop) {
    __ call_VME(CAST_FROM_FN_PTR(address,
                                     InterpreterRuntime::
    ...
    __ call_VME(CAST_FROM_FN_PTR(address, InterpreterRuntime::create_exception),
               false, true);
  }
  // throw exception
...
//          JavaThread::popframe_inactive);
  ...
  __ pop(rax);                                   // restore exception
    ...
    __ addptr(rdx, (EnclaveABI::exception_ret - EnclaveABI::interpreter_ret));
    __ jmp(rdx);
