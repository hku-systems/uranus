...
#ifdef ENCLAVE_MPX
  void bndcl(BNDRegister dst, Register src);
  void bndcu(BNDRegister dst, Register src);
  void bndcl(BNDRegister dst, Address src);
  void bndcu(BNDRegister dst, Address src);
  void bndmk(BNDRegister dst, Address src);
  void bndmov(BNDRegister dst, Address src);
  void bndmov(Address dst, BNDRegister src);
  void bndmov(BNDRegister dst, BNDRegister src);
#endif
};
