...
class BNDRegisterImpl: public AbstractRegisterImpl {
public:
    enum {
...
typedef BNDRegisterImpl* BNDRegister;

CONSTANT_REGISTER_DECLARATION(BNDRegister, bnd0 , (0));
CONSTANT_REGISTER_DECLARATION(BNDRegister, bnd1 , (1));
CONSTANT_REGISTER_DECLARATION(BNDRegister, bnd2 , (2));
CONSTANT_REGISTER_DECLARATION(BNDRegister, bnd3 , (3));
