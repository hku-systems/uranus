...
class LinkResolver: AllStatic {
 ...
 public:
  ...
  static void resolve_invokevirtual  (CallInfo& result, Handle recv, Klass* recv_klass, constantPoolHandle pool, int index, TRAPS);
  static void resolve_invokeinterface(CallInfo& result, Handle recv, Klass* recv_klass, constantPoolHandle pool,
                                      int index, TRAPS);
  ...
  static void resolve_invoke         (CallInfo& result, Handle recv, constantPoolHandle pool, int index,
                                      Bytecodes::Code byte, TRAPS, Klass* klass = NULL);
};
