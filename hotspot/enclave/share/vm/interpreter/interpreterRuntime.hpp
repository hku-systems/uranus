...
public:
    ...
    static oop    create_exception(JavaThread* thread, char* name, char* message);
    static oop    create_klass_exception(JavaThread* thread, char* name, oopDesc* obj);
    ...
    // Synchronization
    static void    monitorenter(JavaThread* thread, BasicObjectLock* elem){ CALL_NULL; }
    static void    monitorexit (JavaThread* thread, BasicObjectLock* elem){ CALL_NULL; }
    ...
    static address slow_signature_handler(JavaThread* thread,
                                          Method* method,
                                          intptr_t* from, intptr_t* to) { CALL_NULL; }
